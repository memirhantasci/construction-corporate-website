...
export const districtPages: Record<string, DistrictPageData> = {
  'atasehir-cam-balkon-sineklik': {
    ...
    neighborhoods: ['Küçükbakkalköy', 'İçerenköy', 'Barbaros', 'Aşık Veysel', 'Yeni Sahra', 'Esatpaşa'],
    sections: [
      {
        heading: 'Ataşehir\'de Katlanır Cam Balkon Montajı',
        body:
          'Ataşehir\'deki yeni sitelerin balkonları genelde geniş ve köşeli. Katlanır cam balkon sistemlerimiz bu alanları yağmur ve rüzgârdan korur, yazın camı tamamen açarak ferah bir teras sunar. Profil ve cam kalitesini birlikte seçeriz; ucuz malzeme satmayız, garantili işçilik veririz.',
      },
      {
        heading: 'Isıcamlı Cam Balkon ile Enerji Tasarrufu',
        body:
          'Ataşehir\'in yüksek katlı bloklarında ısıcamlı cam balkon ciddi fark yaratır. Çift cam yapısı ısı kaybını azaltır, dış gürültüyü keser. Balkonunuzu kışın ek oda gibi kullanabilirsiniz. Montajı kendi ustalarımız yapar, contaları su sızdırmazlık testinden geçirir.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği',
        body:
          'Ataşehir sitelerinde pileli sineklik talebi yıl boyu devam ediyor. Pencere ve balkon kapılarına ölçüye özel sineklik üretiyoruz. Evcil hayvan sahipleri için kedi sinekliği modellerimiz var; pet kapısı sayesinde kediniz rahatça çıkıp girer, sinek içeri giremez.',
      },
    ],
  },
  'kadikoy-cam-balkon-sineklik': {
    ...
    heroSubtitle: 'Moda\'dan Bostancı\'ya, deniz manzaralı balkonlara özel çözümler',
    intro:
    ...
    neighborhoods: ['Moda', 'Bostancı', 'Göztepe', 'Fenerbahçe', 'Caferağa', 'Suadiye'],
    sections: [
      {
        heading: 'Kadıköy\'de Katlanır Cam Balkon Uygulamaları',
        body:
          'Dar sokaklı apartmanlardan geniş teraslı villalara kadar her ölçüye katlanır cam balkon kuruyoruz. Paslanmaz aksesuarlı profiller, ısıcamlı cam balkon seçenekleriyle sunuluyor. Yazın balkonu açıp ferahlatıyor, kışın ısı kaybını minimuma indiriyorsunuz.',
      },
      {
        heading: 'Isıcamlı Cam Balkon ile Dört Mevsim Konfor',
        body:
          'Denize bakan dairelerde ısıcamlı cam balkon tercih ediyoruz. Çift cam rüzgâr sesini azaltır, ısı yalıtımını artırır. Profil rengini cepheye göre seçiyoruz; montajı kendi ekibimiz yapıyor, iş bitiminde temiz teslim ediyoruz.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği Çözümleri',
        body:
          'Kadıköy\'de eski binalardan yeni yapılara pileli sineklik montajı yoğun talep görüyor. Kapı ve pencere sinekliklerini atölyemizde hazırlıyoruz. Kedi sinekliği modellerimizle evcil hayvan sahiplerine pratik çözüm sunuyoruz.',
      },
    ],
  },
  'umraniye-cam-balkon-sineklik': {
    ...
    neighborhoods: ['Çamlık', 'Altınşehir', 'Finans Merkezi', 'Parseller', 'Şerifali', 'Yamanevler'],
    sections: [
      {
        heading: 'Yeni Konutlara Katlanır Cam Balkon',
        body:
          'Ümraniye\'deki yeni yapıların çoğu geniş balkonlu. Katlanır cam balkon bu alanları yağmurda koruyup yazın oturma alanına çeviriyor. Site giriş izinleri ve asansör taşıma planlamasını biz hallediyoruz.',
      },
      {
        heading: 'Isıcamlı Cam Balkon ile Enerji Tasarrufu',
        body:
          'Yüksek katlı bloklarda rüzgâr etkisi ciddi. Isıcamlı cam balkon ısıtma giderini düşürür, gürültüyü keser. Profil contalarımız su sızdırmazlık testinden geçiyor; montaj sonrası garanti belgesi veriyoruz.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği Montajı',
        body:
          'Ümraniye sitelerinde pileli sineklik talebi artıyor. Balkon kapılarına sürme, pencerelere menteşeli sineklik takıyoruz. Kedi sinekliği sistemlerimiz pet geçişine izin verirken sinekleri dışarıda tutuyor.',
      },
    ],
  },
  'maltepe-cam-balkon-sineklik': {
    ...
    neighborhoods: ['Başıbüyük', 'Cevizli', 'Küçükyalı', 'Feyzullah', 'Girne', 'Altıntepe'],
    sections: [
      {
        heading: 'Maltepe\'de Katlanır Cam Balkon Sistemleri',
        body:
          'Maltepe balkonları genelde geniş. Katlanır cam balkon ile dört mevsim değerlendirebilirsiniz. Cam panelleri tamamen toplanır; profil sistemlerimiz sessiz kayar, paslanmaya karşı korumalıdır.',
      },
      {
        heading: 'Isıcamlı Cam Balkon ile Balkonunuzu Odaya Çevirin',
        body:
          'Rüzgârlı günlerde ısıcamlı cam balkon ciddi konfor sağlıyor. Çift cam buhar tutmaz, balkonunuzu çay odası veya çalışma alanı olarak kullanabilirsiniz.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği Hizmeti',
        body:
          'Eski apartman pencerelerinden yeni site girişlerine pileli sineklik montajı yapıyoruz. Kedi sinekliği modellerimiz pet kapısıyla pratik kullanım sunar. Sineklik tamiri için de arayabilirsiniz.',
      },
    ],
  },
  'uskudar-cam-balkon-sineklik': {
    ...
    neighborhoods: ['Kuzguncuk', 'Altunizade', 'Bulgurlu', 'Çengelköy', 'Beylerbeyi', 'Acıbadem'],
    sections: [
      {
        heading: 'Üsküdar\'da Katlanır Cam Balkon Montajı',
        body:
          'Manzara odaklı balkonlarda katlanır cam balkon camı kenara toplayarak görüşü kapatmaz. İnce profil serilerimiz estetik kaybı minimum tutar. Eski binalarda güvenli montaj için gerekli önlemleri alıyoruz.',
      },
      {
        heading: 'Isıcamlı Cam Balkon ile Sessiz Balkon',
        body:
          'Yokuşlu sokaklarda rüzgâr ve trafik sesi rahatsız edici olabiliyor. Isıcamlı cam balkon ses yalıtımını artırır, kışın balkonunuz sıcak kalır.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği Çözümleri',
        body:
          'Ahşap doğramadan PVC\'ye pileli sineklik uyumlu montaj yapıyoruz. Her ölçüye özel üretim. Kedi sinekliği talebi zemin kat dairelerde yoğun; pet geçişli modellerimiz dayanıklıdır.',
      },
    ],
  },
  'beykoz-cam-balkon-sineklik': {
    ...
    neighborhoods: ['Kavacık', 'Çubuklu', 'Anadoluhisarı', 'Paşabahçe', 'Göktürk', 'Riva'],
    sections: [
      {
        heading: 'Beykoz\'da Katlanır Cam Balkon',
        body:
          'Geniş teraslı Beykoz evlerinde katlanır cam balkon balkonu kapalı alana çevirir. Cam tamamen açıldığında manzara korunur. Profil renklerini doğayla uyumlu tonlarda seçebilirsiniz.',
      },
      {
        heading: 'Isıcamlı Cam Balkon ile Kış Bahçesi',
        body:
          'Beykoz\'un serin günlerinde ısıcamlı cam balkon balkonunuzu kullanılabilir tutar. Çift cam ısı kaybını azaltır; kış bahçesi gibi kullanan müşterilerimiz var.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği',
        body:
          'Yeşil alana yakın evlerde pileli sineklik şart. Geniş kapı açılımlarına sürme sineklik, pencerelere menteşeli model takıyoruz. Bahçeli evlerde kedi sinekliği talebi de yoğun.',
      },
    ],
  },
  'kartal-cam-balkon-sineklik': {
    ...
    neighborhoods: ['Yakacık', 'Soğanlık', 'Petrol-İş', 'Cevizli', 'Karlıktepe', 'Orta'],
    sections: [
      {
        heading: 'Kartal\'da Katlanır Cam Balkon Montajı',
        body:
          'Kartal balkonlarına ölçü alarak katlanır cam balkon üretiyoruz. Köşe profilleri sağlam, cam kayması sessiz. İş öncesi plan çıkarıp onayınızı alıyoruz.',
      },
      {
        heading: 'Isıcamlı Cam Balkon Uygulaması',
        body:
          'Soğanlık ve Yakacık\'taki yüksek katlı bloklarda ısıcamlı cam balkon rüzgâr ve soğuğu keser. Enerji tasarrufu sağlar, balkon kullanım alanını genişletir.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği',
        body:
          'Kartal genelinde pileli sineklik montajı yapıyoruz. Balkon kapılarına sürme, pencerelere menteşeli sineklik. Kedi sinekliği ile evcil hayvan sahiplerine pratik çözüm sunuyoruz.',
      },
    ],
  },
  'pendik-cam-balkon-sineklik': {
    ...
    neighborhoods: ['Kurtköy', 'Kaynarca', 'Güzelyalı', 'Velibaba', 'Bahçelievler', 'Yenişehir'],
    sections: [
      {
        heading: 'Pendik\'te Katlanır Cam Balkon',
        body:
          'Pendik\'in geniş balkonlu sitelerinde katlanır cam balkon ideal çözüm. Cam panelleri toplanır, balkon yazın açık hava keyfine döner. Profil garantisi ve işçilik belgesi veriyoruz.',
      },
      {
        heading: 'Isıcamlı Cam Balkon ile Konfor',
        body:
          'Kurtköy\'deki yeni bloklarda ısıcamlı cam balkon ısı ve ses yalıtımı sağlar. Kışın balkonunuzu kullanmaya devam edebilirsiniz. Cam ve profil seçiminde bütçenize uygun seçenekler sunuyoruz.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği',
        body:
          'Pendik sitelerinde pileli sineklik standart ihtiyaç haline geldi. Ölçüye özel üretim, hızlı montaj. Kedi sinekliği modellerimiz pet sahiplerine yaz aylarında büyük kolaylık sağlıyor.',
      },
    ],
  },
  'sancaktepe-cam-balkon-sineklik': {
    ...
    neighborhoods: ['Sarıgazi', 'Abdurrahmangazi', 'Veysel Karani', 'Samandıra', 'Mevlana', 'Yenidoğan'],
    sections: [
      {
        heading: 'Sancaktepe\'de Katlanır Cam Balkon',
        body:
          'Yeni sitelerin balkonlarına katlanır cam balkon kuruyoruz. Geniş açılım, sağlam profil, uzun ömürlü aksesuar. Montaj sürecini site yönetimine bildiriyoruz.',
      },
      {
        heading: 'Isıcamlı Cam Balkon Montajı',
        body:
          'Sancaktepe\'nin rüzgârlı konumunda ısıcamlı cam balkon balkon konforunu artırır. Çift cam yapısı ısı kaybını azaltır; kış aylarında balkonunuz kullanılabilir kalır.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği',
        body:
          'Sancaktepe\'de pileli sineklik fiyatını keşif sonrası net söylüyoruz. Pencere ve kapı sinekliklerini atölyemizde üretiyoruz. Kedi sinekliği ile evcil hayvanınız özgürce dışarı çıkabilir.',
      },
    ],
  },
  'sultanbeyli-cam-balkon-sineklik': {
    ...
    neighborhoods: ['Necip Fazıl', 'Fatih', 'Abdurrahmangazi', 'Hasanpaşa', 'Mimar Sinan', 'Mehmet Akif'],
    sections: [
      {
        heading: 'Sultanbeyli\'de Katlanır Cam Balkon',
        body:
          'Sultanbeyli dairelerinde katlanır cam balkon ile balkonunuzu koruyup genişletiyoruz. Cam panelleri tamamen açılır; yaz-kış kullanım imkânı sunar. Montaj ekibimiz deneyimli, iş bitiminde temizlik yapılır.',
      },
      {
        heading: 'Isıcamlı Cam Balkon Sistemleri',
        body:
          'Kış aylarında balkonunuzu ısıtmak pahalı olabilir. Isıcamlı cam balkon ısı kaybını ciddi azaltır. Sultanbeyli\'de birçok dairede bu sistemi kurduk; referans gösterebiliriz.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği',
        body:
          'Sultanbeyli\'de pileli sineklik en çok yaz aylarında talep görüyor. Erken randevu almanızı öneririz. Kedi sinekliği modellerimiz apartman dairelerinde pratik kullanım sağlar.',
      },
    ],
  },
  'tuzla-cam-balkon-sineklik': {
    ...
    neighborhoods: ['Aydınlı', 'İçmeler', 'Postane', 'Orhanlı', 'Tepeören', 'Mimarsinan'],
    sections: [
      {
        heading: 'Tuzla\'da Katlanır Cam Balkon',
        body:
          'Sahil bölgesinde katlanır cam balkon için deniz havasına dayanıklı malzeme şart. Profillerimiz bu koşullara uygun. Geniş balkonlara özel ölçü üretim yapıyoruz.',
      },
      {
        heading: 'Isıcamlı Cam Balkon Uygulaması',
        body:
          'Tuzla\'nın rüzgârlı sahil hattında ısıcamlı cam balkon konfor sağlar. Çift cam ısı ve ses yalıtımı sunar. Balkonunuzu kış bahçesi gibi kullanabilirsiniz.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği',
        body:
          'Tuzla sitelerinde pileli sineklik montajı yapıyoruz. Deniz kenarında sinek yoğunluğu artar; kaliteli tül ve sağlam profil önemli. Kedi sinekliği taleplerini de karşılıyoruz.',
      },
    ],
  },
  'cekmekoy-cam-balkon-sineklik': {
    ...
    neighborhoods: ['Alemdağ', 'Taşdelen', 'Ömerli', 'Hamidiye', 'Mehmet Akif', 'Sultançiftliği'],
    sections: [
      {
        heading: 'Çekmeköy\'de Katlanır Cam Balkon',
        body:
          'Villa teraslarında katlanır cam balkon manzarayı kapatmadan koruma sağlar. Geniş açılımlı sistemlerimiz sağlam profille desteklenir. Ölçü alımından montaja titiz çalışıyoruz.',
      },
      {
        heading: 'Isıcamlı Cam Balkon ile Dört Mevsim',
        body:
          'Çekmeköy\'ün serin mahallelerinde ısıcamlı cam balkon balkonu kullanılabilir tutar. Kışın ek oda, yazın açık teras — ikisini de sunuyoruz.',
      },
      {
        heading: 'Pileli Sineklik ve Kedi Sinekliği',
        body:
          'Yeşil alana yakın evlerde pileli sineklik olmazsa olmaz. Geniş kapılara sürme sineklik takıyoruz. Kedi sinekliği ile bahçe kapısı geçişlerini güvenli hale getiriyoruz.',
      },
    ],
  },
...
export const serviceAreaCards = districtNavItems.map((item, index) => ({
  district: item.district,
  slug: item.slug,
  description: districtPages[item.slug].cardDescription,
  image: index % 2 === 0 ? '/images/cambalkon.jpeg' : '/images/sineklik.jpeg',
}));
