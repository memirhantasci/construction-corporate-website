...
export default function AllDistrictsPage() {
  return (
    <>
      <SeoMeta
        title={`Hizmet Bölgelerimiz | ${SITE.name} — Anadolu Yakası`}
        description="Ataşehir, Kadıköy, Ümraniye, Maltepe ve tüm Anadolu Yakası ilçelerinde cam balkon, pileli sineklik ve kedi sinekliği montajı. Bölgenizi seçin."
        path="/bolgeler"
      />
      ...
      <div className="min-h-screen bg-cream">
        ...
        <div className="pt-32 pb-12 px-8 text-center">
          ...
          {/* Başlık rengini text-white yerine text-navy yaptı */}
