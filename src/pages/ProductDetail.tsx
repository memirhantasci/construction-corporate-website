...
// Her ürünün detaylı bilgileri burada tutuluyor
const productData: any = {
  'aluminyum-dograma': {
    ...
    images: ['/images/aluminyum-1.jpeg', '/images/aluminyum-2.jpg']
  },
  'cam-balkon': {
    ...
    images: ['/images/cambalkon-1.jpeg', '/images/cambalkon-2.jpg']
  },
  'dusakabin': {
    ...
    images: ['/images/dusakabin-1.jpeg']
  },
  'korkuluk': {
             ...
             {product.images.map((img: string, i: number) => (
               <div key={i} className="overflow-hidden rounded-sm shadow-xl bg-gray-100">
                 <img 
                    ...
                    onError={(e) => { (e.target as any).src = 'https://placehold.co/600x400?text=Gorsel+Hazirlaniyor'; }}
                 />
               </div>
             ))}
          </div>
